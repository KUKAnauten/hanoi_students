...
## 2.2 Verwendung von `planAndMove`und `moveAlongCartesianPathInWorldCoords`
...
## 2.3 Setzen der Turmposen und der Basispose
...
## 2.4 Ausführen des Codes
### 2.4.1 Starten der ROS-Umgebung und benötigter Nodes
...
### 2.4.2 Kompilieren und Starten des Hanoi Nodes
